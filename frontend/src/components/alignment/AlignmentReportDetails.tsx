...
export function AlignmentReportDetails({ report }: AlignmentReportDetailsProps) {
  ...
  return (
    <div className="flex flex-col gap-5 animate-[fadeUp_0.4s_ease]">
      ...
      {/* Header Card */}
      <div className="bg-bg-surface border border-border rounded-[16px] p-6 px-7 flex flex-col gap-4 dark:bg-dark-bg-surface dark:border-dark-border">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        {/* Fortalezas */}
        <div className="bg-bg-surface border border-border rounded-[14px] p-5 px-6 flex flex-col gap-4 dark:bg-dark-bg-surface dark:border-dark-border">
        ...
        {/* Justificación */}
        <div className="bg-bg-surface border border-border rounded-[14px] p-5 px-6 flex flex-col gap-4 lg:col-span-2 dark:bg-dark-bg-surface dark:border-dark-border">
          <div className="flex items-center gap-[10px]">
            <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 bg-accent-soft text-accent dark:bg-dark-accent-soft dark:text-dark-accent">
      ...
      <div className="flex items-center gap-2.5 mt-1 pb-4">
        <button
          ...
          className="inline-flex items-center gap-2 py-[0.65rem] px-[1.25rem] bg-accent text-white border-[1.5px] border-accent rounded-[10px] font-sans text-[13.5px] font-medium cursor-pointer transition-all duration-150 hover:bg-accent-hover hover:border-accent-hover dark:bg-dark-accent dark:border-dark-accent dark:hover:bg-dark-accent-hover dark:hover:border-dark-accent-hover"
        >
