...
export default function RegisterPage() {
  ...
  const handleConfirm = () => {
    ...
    const user: AuthUser = {
      ...
      email,
      estudiante: profileData.historial.estudiante,
      periodos_academicos: profileData.historial.periodos_academicos,
      resumen_creditos: profileData.historial.resumen_creditos,
      cv_text: profileData.cv?.cv_text || '',
      pdf_urls: profileData.pdf_urls,
    };
    login(user, '');
    navigate('/home');
  };
