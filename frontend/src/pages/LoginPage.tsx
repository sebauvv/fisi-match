	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			const user: AuthUser = {
				...
				email: res.email,
				estudiante: {
					nombres_apellidos: fullProfile.nombres_apellidos || res.nombres_apellidos,
					codigo_matricula: fullProfile.codigo_matricula || '',
					facultad: fullProfile.facultad || '',
					escuela: fullProfile.escuela || '',
					plan: fullProfile.plan || '',
				},
				periodos_academicos: fullProfile.periodos_academicos || [],
				resumen_creditos: fullProfile.resumen_creditos || {
